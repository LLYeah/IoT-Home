...
public class TwoFragment extends Fragment {
    ...
    private LineChart mChart1;//界面1
    private LineChart mChart2;//界面2
    ...
    private void initView(View view){
        mChart1 = (LineChart) view.findViewById(R.id.chart1);//界面1
        mChart2 = (LineChart) view.findViewById(R.id.chart2);//界面1
        showChart1(getLineData());
        showChart2(getLineData());
        networkThread.start();
    }
    ...
    private void addChartEntry1() {
        ...
        Log.w("msg","UI界面 温度："+temp);
        mChart1.notifyDataSetChanged();// 使用新数据刷新图表
        mChart1.setVisibleXRangeMaximum(12);// 当前统计图表中最多在x轴坐标线上显示的总量
        mChart1.moveViewToX(lineData1.getXValCount() - 12);
    }
    // 为低温线添加一个坐标点
    private void addChartEntry2() {
        // 获取图表数据
        LineData lineData1 = mChart2.getData();
        // 添加横坐标值
        lineData1.addXValue((lineData1.getXValCount()) + "");
        ...
        Log.w("msg","UI界面 温度： 湿度："+humi);
        mChart2.notifyDataSetChanged();// 使用新数据刷新图表
        mChart2.setVisibleXRangeMaximum(12); // 当前统计图表中最多在x轴坐标线上显示的总量
        mChart2.moveViewToX(lineData1.getXValCount() - 12);
    }
    /**
     * 获取折线数据
     *
     ...
     * 显示图表
     */
    private void showChart1(LineData lineData) {
        // 初始化图表
        initChart1();
        // 数据显示的颜色
     ...
     * 显示图表
     */
    private void showChart2(LineData lineData) {
        // 初始化图表
        initChart2();
        // 数据显示的颜色
        lineData.setValueTextColor(Color.BLACK);
    ...
    private void initChart2() {
        ...
        // 设置图表的背景颜色
        mChart2.setBackgroundColor(0xfff5f5f5);
        // 图表注解（只有当数据集存在时候才生效）
